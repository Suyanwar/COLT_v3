...
<div class="content">
    ...
    <h1><span class="fa fa-circle-o-notch"></span> Growth <sup><span class="fa fa-info-circle tooltip"><span class="tooltiptext"><b>Growth</b><hr>Jumlah pertumbuhan <i>follower</i> pada periode saat ini.</span></span></sup></h1>
...
function reportLoad(){
    report_load('highlight_Summary', 'twitter', 'highlight_Summary', <?php echo $account ?>, {});
    report_load('highlight_Growth', 'twitter', 'highlight_Growth', <?php echo $account ?>, {});
}
</script>