...
<div class="content">
    <h1><span class="fa fa-circle-o-notch"></span> Top Tweet <sup><span class="fa fa-info-circle tooltip"><span class="tooltiptext"><b>Top Tweet</b><hr>Daftar <i>account</i> dan kompetitor yang di urutkan berdasarkan <i>tweet</i> terbanyak.</span></span></sup></h1>
    <div id="summary_TopPosting"></div>
    
    <h1><span class="fa fa-circle-o-notch"></span> Top Followers <sup><span class="fa fa-info-circle tooltip"><span class="tooltiptext"><b>Top Followers</b><hr>Daftar <i>account</i> dan kompetitor yang di urutkan berdasarkan <i>follower</i> terbanyak.</span></span></sup></h1>
...
function reportLoad(){
    report_load('summary_TopPosting', 'twitter', 'summary_TopPosting', <?php echo $account ?>, {});
    report_load('summary_TopFollowers', 'twitter', 'summary_TopFollowers', <?php echo $account ?>, {});
    report_load('summary_TopFeedback', 'twitter', 'summary_TopFeedback', <?php echo $account ?>, {});
    report_load('summary_EffectiveCommunication', 'twitter', 'summary_EffectiveCommunication', <?php echo $account ?>, {});
}
</script>