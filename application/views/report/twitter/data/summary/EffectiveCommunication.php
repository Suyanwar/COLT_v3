...
if($data){
	...
	foreach($data as $list){
		...
		//$data .= '<td>'.$i.'</td>';
		$data = '<td><a href="'.($list->username ? 'https://twitter.com/'.$list->username : 'https://twitter.com/intent/user?user_id='.$list->socmed_id).'" target="_blank" title="'.$list->account_id.'">'.$list->name.'</a></td>';
