...
<div class="content">
    ...
    <h1><span class="fa fa-circle-o-notch"></span> <?php echo $account->name ?> <font style="text-transform:lowercase">VS</font> Competitor <sup><span class="fa fa-info-circle tooltip"><span class="tooltiptext"><b><?php echo $account->name ?> vs Competitor</b><hr>Perbandingan <i>fans</i> antara <i>account</i> dengan kompetitor.</span></span></sup></h1>
...
function reportLoad(){
    report_load('performance_Summary', 'facebook', 'performance_Summary', <?php echo $account->account_id ?>, {});
    report_load('performance_VsCompetitor', 'facebook', 'performance_VsCompetitor', <?php echo $account->account_id ?>, {});
    report_load('performance_Interaction', 'facebook', 'performance_Interaction', <?php echo $account->account_id ?>, {});
}
</script>