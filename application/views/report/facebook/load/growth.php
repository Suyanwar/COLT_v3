...
function reportLoad(){
    report_load('growth_DailyFans', 'facebook', 'growth_DailyFans', <?php echo $account ?>, {});
    report_load('growth_DailyGrowth', 'facebook', 'growth_DailyGrowth', <?php echo $account ?>, {});
    report_load('growth_MonthlyFans', 'facebook', 'growth_MonthlyFans', <?php echo $account ?>, {});
    report_load('growth_MonthlyGrowth', 'facebook', 'growth_MonthlyGrowth', <?php echo $account ?>, {});
	<?php
    if($data){
        $i = 1;
        foreach($data as $list){
			if($i < 4)
			echo "report_load('growth_MonthlyGrowthCompetitor_{$list->account_id}', 'facebook', 'growth_MonthlyGrowthCompetitor', $list->account_id, {});";
            $i++;
        }
    }
    ?>
