...
<div class="content">
    ...
    <h1><span class="fa fa-circle-o-notch"></span> Base on City <sup><span class="fa fa-info-circle tooltip"><span class="tooltiptext"><b>Base on City</b><hr>Pemetaan <i>user</i> pada periode saat ini berdasarkan kota.</span></span></sup></h1></span></span></sup></h1>
...
function reportLoad(){
    report_load('demography_Country', 'facebook', 'demography_Country', <?php echo $account ?>, {});
    report_load('demography_State', 'facebook', 'demography_State', <?php echo $account ?>, {});
    report_load('demography_City', 'facebook', 'demography_City', <?php echo $account ?>, {});
}
</script>