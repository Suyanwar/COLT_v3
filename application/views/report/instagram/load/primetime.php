...
function reportLoad(){
    report_load('primetime_DailyPost', 'instagram', 'primetime_DailyPost', <?php echo $account ?>, {});
    report_load('primetime_DailyComment', 'instagram', 'primetime_DailyComment', <?php echo $account ?>, {});
}
</script>